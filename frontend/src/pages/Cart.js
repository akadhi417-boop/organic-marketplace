                ...
                {cart.items.map((item) => (
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-muted mb-3">₹{Number(item?.price ?? 0).toFixed(2)} per {item.unit}</p>
              ...
              <div className="lg:col-span-1">
                <div className="bg-white rounded-2xl shadow-lg border border-[#E5E0D8] p-6 sticky top-6">
                  ...
                  <div className="flex justify-between mb-6">
                    ...
                    <span className="text-3xl font-bold text-moss" data-testid="cart-total">₹{Number(total ?? 0).toFixed(2)}</span>
                  </div>
